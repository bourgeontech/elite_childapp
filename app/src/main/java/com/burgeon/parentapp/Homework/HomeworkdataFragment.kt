...
import com.burgeon.parentapp.ListdestitutesPagination.HomeworkListAdapter
import com.burgeon.parentapp.ListdestitutesPagination.HomeworkListViewModel
...
class HomeworkdataFragment : Fragment() {
    ...
    private lateinit var newsListAdapter: HomeworkListAdapter

    private lateinit var viewModelSearch: HomeworkListViewModel
    private lateinit var newsListAdapterSearch: HomeworkListAdapter
    ...
    override fun onCreateView(
        ...
        val view: View = inflater.inflate(R.layout.fragment_homework, container, false)
    ...
    private fun _funBeneficiary() {
        viewModel = ViewModelProvider(this, object : ViewModelProvider.Factory {
            ...
            override fun <T : ViewModel> create(@NonNull modelClass: Class<T>): T {
                return HomeworkListViewModel(childIdClassid!!, childIdSectionid!!, "", "") as T
            }
        }).get(HomeworkListViewModel::class.java!!)
    }


    private fun initAdapter() {
        newsListAdapter = HomeworkListAdapter { viewModel.retry() }
